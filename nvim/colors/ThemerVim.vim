  ...
  let s:guishade0 = "#0d0e11"
  let s:guishade1 = "#333a48"
  let s:guishade2 = "#475164"
  let s:guishade3 = "#5d6a83"
  let s:guishade4 = "#d4d4d4"
  let s:guishade5 = "#d4d4d4"
  let s:guishade6 = "#d4d4d4"
  let s:guishade7 = "#eeeeee"
  let s:guiaccent0 = "#ec5e66"
  let s:guiaccent1 = "#ff8a47"
  let s:guiaccent2 = "#fac862"
  let s:guiaccent3 = "#99c793"
  let s:guiaccent4 = "#5fb3b2"
  let s:guiaccent5 = "#6699cb"
  let s:guiaccent6 = "#a690c6"
  let s:guiaccent7 = "#c78eb0"
